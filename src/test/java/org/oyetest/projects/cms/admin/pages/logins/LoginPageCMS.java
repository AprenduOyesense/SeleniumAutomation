package org.oyetest.projects.cms.admin.pages.logins;
...
import org.oyetest.projects.cms.users.pages.dashboard.DashboardPage;
import org.openqa.selenium.By;

import static org.oyetest.keywords.WebUI.*;
import static org.oyetest.keywords.WebUI.clickElement;
...
public class LoginPageCMS extends CommonPageCMS {
    ...
    private By titleoyetestAdminPage = By.xpath("//img[@alt='Active eCommerce CMS']");
    ...
    public CommonPageCMS loginSuccessAdminPage(String email, String password) {
        ...
        setText(inputPassword, password);
        clickElement(buttonSubmitLogin);
        waitForElementVisible(titleoyetestAdminPage);
        verifyElementVisible(titleoyetestAdminPage, "Admin page is NOT displayed.");
